  ...
  return (
    <div className="text-white bg-[#282C34] py-24  sm:mt-32  sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto  lg:mx-0 flex justify-between lg:flex-row sm:flex-col ">
          <div>
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              My projects
            </h2>
            <p className="mt-2 text-xs lg:text-lg sm:text-2xl leading-8 text-gray-300">
              I like programming
            </p>
          </div>
        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {repos.map((repo) => (
            ...
            >
              <div className="flex items-center gap-x-4 text-xs lg:text-xs sm:text-3xl">
              ...
              <div className="flex  w-full items-center">
                <div className="flex text-xs lg:text-base sm:text-3xl justify-center pr-5 items-center h-full ">
                  <IoStar />
              ...
              <div className="group relative">
                <h3 className="mt-3 text-xs lg:text-lg sm:text-3xl font-semibold leading-6 text-gray-200 group-hover:text-gray-600">
                  <a href={repo.html_url}>
                    <span className="absolute inset-0 " />
                    {repo.name}
                  </a>
                </h3>
                <p className="mt-5 line-clamp-3 text-xs lg:text-base sm:text-2xl leading-6 text-gray-300">
