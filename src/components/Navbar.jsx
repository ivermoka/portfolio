...
const Navbar = ({ currentTab }) => {
  return (
    <div className="fixed w-full z-50">
      <section className="h-[4vh] flex items-center justify-center bg-[#26292d] text-[#adb0b5] text-lg">
        ivermoka_portfolio
        <div className="absolute right-0 pr-4">- # X</div>
      </section>
      <section className="h-[4.5vh] w-full flex justify-start bg-[#1D1F23] text-[#828488]">
